          ...
          {PRAYER_NAMES.map((prayer, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] sm:text-xs font-medium text-foreground/80 text-center">{prayer.name}</span>
                <span className="text-[8px] sm:text-[10px] text-muted-foreground">{prayer.emoji}</span>
              </motion.button>
            );
          })}
        </div>
